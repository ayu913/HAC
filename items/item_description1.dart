...
class ItemDescription1 extends StatefulWidget {
  final Item1 item;

  ItemDescription1({@required this.item});

  @override
  _ItemDescription1State createState() => _ItemDescription1State();
}

class _ItemDescription1State extends State<ItemDescription1>
