...
class Nutrilite extends StatefulWidget {
  Nutrilite({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _NutriliteState createState() => _NutriliteState();
}

class _NutriliteState extends State<Nutrilite> with TickerProviderStateMixin {
