...
void main() => runApp(Med3());

class Med3 extends StatelessWidget {
...
class Immune extends StatefulWidget {
  Immune({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _ImmuneState createState() => _ImmuneState();
}

class _ImmuneState extends State<Immune> with TickerProviderStateMixin {
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: Text(
                          "Charak Pharma Extrammune Tablet ",
                          style: TextStyle(
                              color: Colors.black,
